...
<div
  class="hover:scale-105 duration-700 mb-12 flex pop flex-col justify-around bg-gray-800 p-4 border border-white border-opacity-30 rounded-lg shadow-md w-[340px] h-[200px] mx-auto"
>
  <div class="flex flex-row items-center justify-between mb-3">
   <p className=' text-white font-semibold text-lg tracking-widest uppercase ' >{currentUser?.name}</p>
    <div
  ...
  <div class="flex flex-col space-y-8  ">
   ...
   <p  class="text-[10px] tracking-widest text-gray-400 ">
current balance 
   </p>
...
<div
  class="flex pop items-center justify-center bg-gray-800 overflow-hidden p-1 border border-white border-opacity-30 rounded-lg shadow-md h-[50px]"
>
  <input
    class="w-42 h-full border-none outline-none bg-gray-800 text-white font-medium caret-orange-500 pl-2 "
    type="number"
    name="text"
    id="input"
    value={amount}
    ...
    >
      ...
      ></path>
        ...
        <button onClick={handleAddAmount} className="flex items-center justify-center gap-x-4 p-1 text-gray-100 h1 text-lg tracking-widest rounded-lg px-14 bg-black">
          <img className='w-10' src="https://img.icons8.com/?size=100&id=JQX2fDPyQq4E&format=png&color=000000" alt="" />
...
(
  <div className='flex justify-center items-center flex-col w-full h-full'>
        <img className='w-[300px]' src="https://i.pinimg.com/originals/f8/c4/22/f8c422a0a0e6793b3f9113d419c5143a.gif
    " alt="" />
